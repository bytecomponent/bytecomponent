...
#### **TheSortilege** - Многофункциональная веб-платформа
- **Статус:** Активная разработка 🟢
- **Стек:** Vue 3 + Nuxt 3 + Flask + MySQL
- **Функции:** <a href="https://github.com/TheSortilege/TheSortilege">Можете узнать в открытом репозитории с общедоступной информацией о релизах</a>
